...
const CreatorUpdateExperienceForm = props => {
  ...
  useEffect(() => {
    axiosWithAuth()
      .get(`https://wanderlustbw.herokuapp.com/locations/${props.location_id}`)
      .then(response => {
  ...
  useEffect(() => {
    ...
    axiosWithAuth()
      ...
      .then(response => {
        ...
        axiosWithAuth()
          .get(
            `https://wanderlustbw.herokuapp.com/locations/${response.data.location_id}`
          )
          .then(res => {
  ...
  function handleGeosuggestChange(value) {
    ...
    axiosWithAuth()
      .get(
        `https://wanderlustbw.herokuapp.com/locations/location/${selectedPlace}`
      )
      .then(response => {
        if (response.data.id > 0) {
          ...
          setExperience({
            ...experience,
            [locationPlaceholder]: response.data.id
          });
        } else {
          exists = false;
  ...
  const handleUpdate = () => {
    ...
    axiosWithAuth()
      .put(
        `https://wanderlustbw.herokuapp.com/exp/experience/${id}`,
        experience
      )
      .then(response => {
    ...
    <>
      ...
      <div className="new-experience">
        ...
        <form className="new-experience-form" onSubmit={handleUpdate}>
          ...
          <input
            className="new-experience-input"
            type="text"
            name="name"
          ...
          <div className="date-dur-loc">
            ...
            <div className="column">
              <label className="label" for="duration">
                Duration in hours:{" "}
              </label>
              <input
                className="small-input"
            ...
            <div className="column">
              ...
              <Geosuggest
                ...
                onSuggestSelect={handleGeosuggestChange}
              />
            </div>
          </div>
